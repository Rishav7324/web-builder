...
Apply least privilege, secure secret handling, input validation, authentication, authorization/RBAC, rate limiting where applicable, secure uploads, security headers, audit logging for privileged actions, and OWASP-aligned mitigations.
